...
app.get("/", (req, res) => {
    res.status(200)
      .send(`<div style="text-align: center; background-color:#FBF3D5;  padding: 10px;"><h1>Mentor and Student Assigning with Database</h1></div>
      <div>
      <h1  style="text-align: center;">For Mentor</h1>
      <h3>API:http://localhost:4000/api/mentor</h3>
      <ul>
      <li>
      ...
      <h3>API:http://localhost:4000/api/student</h3>
      <ul>
      <li>
